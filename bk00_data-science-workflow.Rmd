...
knitr::include_graphics("diagrams/data-ability.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align='center'}
knitr::include_graphics("diagrams/automation.png")
```
...
knitr::include_graphics("diagrams/reproducible-research.png")
```
